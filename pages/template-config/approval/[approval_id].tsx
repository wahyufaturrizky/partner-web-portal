...
const DetailTemplateConfigApprovalList: any = () => {
	...
	const onSubmit = (data: any) => {
		...
		updateTemplateApproval(payload);
	};

	const { mutate: updateTemplateApproval } = useUpdateTemplateApproval({
		approval_id,
		options: {
			onSuccess: () => {
				// window.alert("template approval updated successfully");
				toast.success("template approval updated successfully");
				router.back();
			},
		},
	});
...
export default DetailTemplateConfigApprovalList;
