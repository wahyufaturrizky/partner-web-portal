...
import {
  Text, Button, Col, Row, Spacer, Search, Table, Pagination, Dropdown,
} from "pink-lava-ui";
    ...
    data.push({
      ...
      action: (
        <Button
          size="small"
          onClick={() => {
            router.push(`/config/user-config/permission/${field.id}`);
          }}
          variant="tertiary"
        >
      ...
      <HeaderFilter>
        ...
        <Row gap="16px">
          <Button
            ...
            hidden
            onClick={() => {
              router.push("/config/user-config/permission/create");
            }}
          >
