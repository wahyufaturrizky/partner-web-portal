...
const DetailPartnerConfigPermissionList: any = () => {
  ...
  const { data: dataPartnerConfigPermissionList, isLoading: isLoadingPartnerConfigPermissionList } = usePartnerConfigPermissionList({
      ...
      <Col>
        <Row gap="4px" alignItems="center">
          ...
          <Text variant="h4">
            Permission Detail -
            {' '}
            {dataPartnerConfigPermissionList?.name || "Unknown"}
          </Text>
                      ...
                      dataPartnerConfigPermissionList?.associatedRole?.map((data: any) => (
                        <Record borderTop key={data.id}>
                          ...
                          <Button
                            size="small"
                            // href={}
                            // onClick={() => router.push(`/config/user-config/role/${data.id}`)}
                            variant="tertiary"
                          >
