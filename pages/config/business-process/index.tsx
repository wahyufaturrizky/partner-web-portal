...
import {
  Text, Button, Col, Row, Spacer, Search, Table, Pagination, Lozenge,
} from "pink-lava-ui";
          ...
          action: (
            <div style={{ display: "flex", justifyContent: "left" }}>
              <Button
                size="small"
                onClick={() => {
                  router.push(`/config/business-process/${element.id}`);
                }}
                variant="tertiary"
              >
            ...
            <Row gap="16px">
              ...
              {listPermission?.filter((data: any) => data.viewTypes[0]?.viewType.name === "Create")
                ...
                <Button
                  size="big"
                  variant="primary"
                  onClick={() => router.push("/config/business-process/create")}
                >
