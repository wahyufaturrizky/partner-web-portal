...
const downloadFile = (params: any) => mdmDownloadService("/cost-center/download", { params }).then((res) => {
          ...
          action: listPermission?.filter((data: any) => data.viewTypes[0]?.viewType.name === "View")
            ...
            <div style={{ display: "flex", justifyContent: "left" }}>
              <Button
                size="small"
                onClick={() => {
                  router.push(`/mdm/cost-center/${element.companyId}/${element.costCenterId}`);
                }}
                variant="tertiary"
              >
                View Detail
      ...
      <Card>
        <Row justifyContent="space-between">
          ...
          <Row gap="16px">
            ...
            />
            <Button size="big" variant="primary" onClick={() => router.push("/mdm/cost-center/create")}>
              Create
            </Button>
          </Row>
        </Row>
