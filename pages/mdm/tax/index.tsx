...
import {
  useCountryTaxes, useDeletTax, useTaxes, useTaxInfiniteLists, useUploadFileTax,
...
const downloadFile = (params: any) => mdmDownloadService("/tax/download", { params }).then((res) => {
              ...
              action: (
                <div style={{ display: "flex", justifyContent: "left" }}>
                  <Button
                    size="small"
                    onClick={() => {
                      router.push(`/mdm/tax/${element.countryId}`);
                    }}
                    variant="tertiary"
                  >
                    View Detail
