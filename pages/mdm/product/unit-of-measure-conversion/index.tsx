...
const downloadFile = (params: any) => mdmDownloadService("/uom-conversion/download", { params }).then((res) => {
          ...
          action: (
            <div style={{ display: "flex", justifyContent: "left" }}>
              <Button
                size="small"
                onClick={() => {
                  router.push(`/mdm/product/unit-of-measure-conversion/${element.conversionId}`);
                }}
                variant="tertiary"
              >
                View Detail
            ...
            {listPermission?.filter((data: any) => data.viewTypes[0]?.viewType.name === "Create")
              .length > 0 && (
                <Button
                  size="big"
                  variant="primary"
                  onClick={() => router.push("/mdm/product/unit-of-measure-conversion/create")}
                >
                  Create
                </Button>
            )}
