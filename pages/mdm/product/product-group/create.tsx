...
import {
  Text, Col, Row, Spacer, Button, Input, Accordion, Table, Pagination,
} from "pink-lava-ui";
...
const ProductGroupCreate = () => {
  ...
  const {
    ...
    defaultValues: {
      items: [{
        group: null, condition: null, value_from: "0", value_to: "0", values: "0",
      }],
    },
  });
          ...
          action: (
            <div style={{ display: "flex", justifyContent: "left" }}>
              <Button
                size="small"
                onClick={() => {
                  router.push(`/mdm/product/product/${item.id}`);
                }}
                variant="tertiary"
              >
                View Detail
