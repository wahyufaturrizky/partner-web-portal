...
import {
  Accordion, Button, Col, Input, Modal, Row, Spacer, Table, Text, Spin,
} from "pink-lava-ui";
...
const ProductOptionDetail = () => {
  ...
  const { mutate: updateProductOption, isLoading: isLoadingUpdateProductOption } = useUpdateProductOptionMDM({
    options: {
      onSuccess: () => {
        router.back();
      },
  ...
  const { mutate: updateProductOptionItem, isLoading: isLoadingUpdateProductOptionItem }: any = useUpdateProductOptionItemMDM({
    options: {
      onSuccess: () => {
  ...
  const { mutate: createProductOptionItem, isLoading: isLoadingCreateProductOptionItem }: any = useCreateProductOptionItemMDM({
    options: {
      onSuccess: () => {
        refetchProductOption();
      },
  ...
  const { mutate: deleteProductOptionItem, isLoading: isLoadingDeleteProductOptionItem }: any = useDeleteProductOptionItemMDM({
    options: {
      onSuccess: () => {
        refetchProductOption();
      },
