...
import {
  Text, Col, Row, Spacer, Dropdown, Button, Accordion, Input, Spin,
} from "pink-lava-ui";
...
const UpdateProductCategory: any = () => {
  ...
  const { mutate: updateProductCategory, isLoading: isLoadingUpdateProductCategory } = useUpdateProductCategory({
    id: category_id,
    company_id: companyCode,
    options: {
      onSuccess: () => {
        alert("Update Success!");
        router.push("/mdm/product-category");
      },
    },
  });
