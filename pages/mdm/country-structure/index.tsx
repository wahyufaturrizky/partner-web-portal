      ...
      ? [
        {
          ...
          render: ({ countryID }: { countryID: string }) => (
            <Button size="small" onClick={() => router.push(`/mdm/country-structure/${countryID}`)} variant="tertiary">
              View Detail
            </Button>
          ),
        },
  ...
  <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
    ...
    <p style={{ margin: "0" }}>Download Data</p>
              ...
              {listPermission?.filter((data: any) => data.viewTypes[0]?.viewType.name === "Create")
						  .length > 0 && (
							<Button size="big" variant="primary" onClick={() => router.push("/mdm/country-structure/create")}>
  Create
							</Button>
              )}
