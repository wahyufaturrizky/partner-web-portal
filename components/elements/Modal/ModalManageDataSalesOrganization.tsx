...
import { useCreateUOMLevelConversion, useDeletUOMLevelConversion, useUOMConversionLevelInfiniteLists, useUOMConversionsLevel } from "hooks/mdm/unit-of-measure-conversion/useUOMConversion";
import useDebounce from "lib/useDebounce";
import { queryClient } from "pages/_app";
import usePagination from "@lucasmogari/react-pagination";

export const ModalManageDataEdit = ({onCancel, visible} : {onCancel: any, visible: any}) => {
	...
	return (
		<Modal
			...
			footer={
				...
				>
					<Button size="big" variant="secondary" key="submit" type="primary" onClick={() => {}}>
						Cancel
					</Button>
					<Button variant="primary" size="big" onClick={() => {}}>
						{"Save"}
					</Button>
				</div>
			}
