    ...
    <>
      <Col>
        <Row gap="4px" alignItems="center">
          <ArrowLeftIcon onClick={() => Router.push('/claim-web/down-payment')} style={{ cursor: 'pointer' }} />
                ...
                <Button
                  ...
                  onClick={() => setModals({
                    ...
                    confirmation: {
                      ...
                      onOk: () => Router.push('/claim-web/down-payment'),
                    },
                  })}
                >
                  Cancel
      ...
      {modals?.alert && (
        <ModalAlert
          ...
          onOk={() => {
            closeModals();
            Router.push('/claim-web/down-payment');
          }}
        />
      )}
    </>
