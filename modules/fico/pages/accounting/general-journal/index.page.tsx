...
const GeneralJournal = () => {
  ...
  // const data = [
  //   {
  //     ID: 1, document_number: '190000001', company_code: 'PP01', company_name: 'Kaldu Sari Nabati Indonesia', document_date: '10-04-2022', posting_date: '10-04-2022', reference: 'Reference Text', header_text: 'Header Text', currency: 'IDR', status: 'submitted',
  //   },
  //   {
  //     ID: 2, document_number: '190000002', company_code: 'PP01', company_name: 'Pinus Merah Abadi', document_date: '10-04-2022', posting_date: '10-04-2022', reference: 'Reference Text', header_text: 'Header Text', currency: 'IDR', status: 'submitted',
  //   },
  //   {
  //     ID: 3, document_number: '190000003', company_code: 'PP01', company_name: 'Kaldu Sari Nabati Indonesia', document_date: '10-04-2022', posting_date: '10-04-2022', reference: 'Reference Text', header_text: 'Header Text', currency: 'IDR', status: 'draft',
  //   },
  //   {
  //     ID: 4, document_number: '190000004', company_code: 'PP01', company_name: 'Pinus Merah Abadi', document_date: '10-04-2022', posting_date: '10-04-2022', reference: 'Reference Text', header_text: 'Header Text', currency: 'IDR', status: 'draft',
  //   },
  // ];
  ...
  return (
    <>
      <Col>
        <Text variant="h4">General Journal</Text>
        <Spacer size={20} />
        <Card>
