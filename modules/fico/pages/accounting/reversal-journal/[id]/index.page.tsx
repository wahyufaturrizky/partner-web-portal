...
function EditReversalJournal() {
  ...
  const updateReversal = service.update({
    id,
    onSuccess: (res) => {
  ...
  const doSubmit = (data) => updateReversal.mutate(getPayload({ ...data, state: 'submit' }));
  const doSave = (data) => updateReversal.mutate(getPayload({ ...data, state: 'draft' }));
          ...
          <Row justifyContent="space-between" alignItems="center">
            ...
            <Row>
              <Row gap="16px">
                ...
                >
                  {updateReversal.isLoading ? 'Loading...' : 'Save as Draft'}
                </Button>
                <Button
                  size="big"
                  variant="primary"
                ...
                >
                  {updateReversal.isLoading ? 'Loading...' : 'Submit'}
                </Button>
              </Row>
            </Row>
          </Row>
...
export default EditReversalJournal;
