...
const PostAccountingVerification = () => {
  ...
  const rowSelection: IRowSelection = {
    ...
    selectionAction: <ButtonActionPopup onSubmit={() => doUpdateStatus(4)} onReject={() => doUpdateStatus(8)} />,
    selectedRowKeys,
    getCheckboxProps: (row: any) => {
      const visibility = ![1, 2, 4].includes(row.status) ? 'hidden' : 'visible';
  ...
  return (
    <>
      <Col>
        <Text variant="h4">Post Accounting Verification</Text>
        <Spacer size={20} />
        <Card>
...
export default PostAccountingVerification;
