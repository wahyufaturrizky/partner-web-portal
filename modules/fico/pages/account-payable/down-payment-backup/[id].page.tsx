...
import { FormDownPayment, DownPaymentFields, getPayload } from './form';
    ...
    <>
      <Col>
        <Row gap="4px" alignItems="center">
          <ArrowLeftIcon onClick={() => Router.push('/account-payable/down-payment')} style={{ cursor: 'pointer' }} />
        ...
        <Spacer size={20} />
        <FormDownPayment form={form} type="update" />
      </Col>
      {modals?.confirmation && (
        <ModalConfirmation
