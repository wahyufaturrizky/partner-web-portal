...
function CreatePurchasingVerification() {
    ...
    <>
                ...
                <Button
                  ...
                  onClick={() => setModals({
                    confirmation: {
                      ...
                      onOk: () => Router.push('/account-payable/purchasing-verification'),
                    },
                  })}
                >
                  Cancel
      ...
      {modals?.alert && (
        <ModalAlert
          ...
          onOk={() => {
            closeModals();
            Router.push('/account-payable/purchasing-verification');
          }}
        />
      )}
    </>
...
export default CreatePurchasingVerification;
