...
import { useQueryMasterPlantAsset } from 'hooks/master-data/useMasterPlantAsset';
...
export const FormAssetMutation = (props: IForm<AssetMutationFields>) => {
  ...
  const fields: IField<AssetMutationFields>[] = [
    ...
    },
    {
      ...
      placeholder: 'Select',
      validation: { required: '* required' },
      datasources: datasources?.sender_dvsn?.map((v) => ({ id: v.cost_center, value: `${v.cost_center} - ${v.controll_area} ${v.currency}` })),
    },
    {
      id: 'vehicles',
      type: 'text',
