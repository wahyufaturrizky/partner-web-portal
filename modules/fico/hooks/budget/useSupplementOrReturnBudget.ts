...
const apiPath = 'v1/suplement-return-budget';

export function useSupplementReturnBudget() {
  ...
  const doFetchByID = async ({ id }) => client(`/${apiPath}/get/${id}?type=supplement`).then((data) => data);
