...
const Template = (args) => (
  <AccordionComponent>
      {faqData.map((item) => (
        <AccordionComponent.Item key={item.id}>
          <AccordionComponent.Header>{item.header}</AccordionComponent.Header>
          <AccordionComponent.Body>{item.body}</AccordionComponent.Body>
