...
export const DropdownMenuOptionCustome = ({
  label,
  subtitle,
  placeholder,
  error,
          ...
          <Row align="middle" justify="space-between">
            ...
            <Row align="middle">
              <Space>
                  ...
                  <TypographyBase
                    ...
                    onClick={() => {
                      if (selectedItems.length === filteredItems.length) {
                        ...
                        setSelecetedItems(
                          filteredItems.map((data) => data.value)
                        );
                        handleChangeValue &&
                          handleChangeValue(
                            filteredItems.map((data) => data.value)
                ...
                <Col>
                  <Caption>{`${selectedItems.length}/${filteredItems.length}`}</Caption>
                </Col>
              </Space>
            </Row>
          </Row>
...
DropdownMenuOptionCustome.propTypes = {
  label: PropTypes.string,
...
DropdownMenuOptionCustome.defaultProps = {
